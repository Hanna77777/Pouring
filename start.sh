...
# 启动第一个 follow1 文件
gnome-terminal -- bash -c "cd /home/dc/Desktop/arx-follow-V2/arx-follow/remote_control/follow1 && source devel/setup.bash && roslaunch arm_control arx5v.launch"
...
# 启动第一个 master1 文件
gnome-terminal -- bash -c "cd /home/dc/Desktop/arx-follow-V2/arx-follow/remote_control/master1 && source devel/setup.bash && roslaunch arm_control arx5v.launch"
